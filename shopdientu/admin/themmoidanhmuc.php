...
<?php include 'inc/sidebar.php';?>
		...
		include 'connect.php';
			...
			if(isset($b))
		 {
		 	...
		 	if($tendm=="")
		 	{
		 		echo "<div id='kq'>Vui long nhap ten danh muc</div>";
		 	}
		 	else if(strlen($tendm)<3 || strlen($tendm)>50)
		 	{
		 		echo "<div id='kq'>Ten danh muc phai lon hon 3 ki tu va nho hon 50 ki tu</div>";
		 	}	 	
		 	else 
		 	{
